...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped mb-0">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $bots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            <tr>
	                                ...
	                                <td>
	                                    ...
	                                    <?php else: ?>
	                                        <a href="<?php echo e(route('bots.connect', ['bots' => $item])); ?>">
	                                ...
	                                <td class="text-end">                                                       
	                                    <a href="<?php echo e(route('bots.edit', ['bots' => $item])); ?>"><i class="btn las la-pen text-secondary font-16"></i> </a>
	                                    <a href="<?php echo e(route('bots.delete', ['bots' => $item])); ?>" onclick="return confirm('Rostdan o`chirmoqchimisiz')"><i class="btn las la-trash-alt text-secondary font-16"></i></a>
	                                </td>
	                            </tr>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tarif:  <?php echo e($bot->name); ?>  o'zgartirilmoqda!</h4>
                    <p class="text-muted mb-0">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                    	...
                    	<form action="<?php echo e(route('bots.update', ['bots'=> $bot])); ?>" method="POST">
            				<?php echo csrf_field(); ?>
                            <div class="mb-3">
		                        <label for="example-text-input">Nomi</label>
		                        <input class="form-control" type="text" name="name" value="<?php echo e($bot->name); ?>"> 
		                    </div>
		                    <div class="mb-3">
		                        <label for="example-text-input">Username</label>
		                        <input class="form-control" type="text" name="username" value="<?php echo e($bot->username); ?>"> 
		                    </div>
		                    <div class="mb-3">
		                        <label for="example-text-input">Token</label>
		                        <input class="form-control" type="text" name="token" value="<?php echo e($bot->token); ?>"> 
		                    </div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('bots.store')); ?>" method="POST">
            	<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/biznesavtomat/data/www/biznesavtomat.uz/project/resources/views/bot/index.blade.php ENDPATH**/ ?>