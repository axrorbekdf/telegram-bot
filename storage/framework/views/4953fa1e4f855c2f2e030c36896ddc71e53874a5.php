                        ...
                        <table class="table table-striped mb-0" id="datatable_1">
                            ...
                            <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            <tr>
	                                ...
	                                <td><?php echo e($item->client->first_name); ?> <?php echo e($item->client->last_name); ?> <a href="https://t.me/<?php echo e($item->client->username); ?>"><?php echo e("@".$item->client->username); ?> </a></td>
                                    <td><?php echo e($item->rate->name ?? $item->rate_id); ?></td>
                                    <td><?php echo e($item->provider->name ?? $item->provider_id); ?></td>
                                    <td><?php echo e($item->currency); ?></td>
                                    <td><?php echo e($item->total_amount); ?></td>
                                    <td><?php echo e($item->invoice_payload); ?></td>
                                    <td><?php echo e($item->order_info); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/biznesavtomat/data/www/biznesavtomat.uz/project/resources/views/payment/index.blade.php ENDPATH**/ ?>