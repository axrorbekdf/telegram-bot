            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Klientlar</li>
                    </ol>
                </div>
                <h4 class="page-title">Klientlar</h4>
            </div>
            <!--end page-title-box-->
        </div>
        <!--end col-->
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">                      
                            <h4 class="card-title">Klientlar ro'yhati</h4>
		                    <p class="text-muted mb-0">
		                        Bu yerda barcha klientlar haqida ma'lumotlarni olish mumkin.
		                    </p>          
                        </div><!--end col-->    
                        <div class="col-auto">                      
                        ...
                        <table class="table table-striped mb-0" id="datatable_1">
                            ...
                            <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	                            <tr>
                                    ...
                                    <td><?php echo e($item->step); ?></td>
                                    <td><?php echo e($item->first_name); ?></td>
                                    <td><?php echo e($item->last_name); ?></td>
                                    <td> <a href="https://t.me/<?php echo e($item->username); ?>" target="_blank"><?php echo e("@".$item->username); ?></a> </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/biznesavtomat/data/www/biznesavtomat.uz/project/resources/views/client/index.blade.php ENDPATH**/ ?>