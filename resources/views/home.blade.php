                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="row d-flex">
                            ...
                            <div class="col-12 ms-auto align-self-center">
                                <h3 class="text-dark my-0 font-22 fw-bold">{{ $client }}</h3>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="row d-flex">
                            ...
                            <div class="col-12 ms-auto align-self-center">
                                <h3 class="text-dark my-0 font-22 fw-bold">{{ $provider }}</h3>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="row d-flex">
                            ...
                            <div class="col-12 ms-auto align-self-center">
                                <h3 class="text-dark my-0 font-22 fw-bold">{{ $payment }}</h3>
                ...
                <div class="card overflow-hidden">
                    <div class="card-body">
                        <div class="row d-flex">
                            ...
                            <div class="col-12 ms-auto align-self-center">
                                <h3 class="text-dark my-0 font-22 fw-bold">{{ $bot }}</h3>
